...
const ThankYouPage = async ({ searchParams }: PageProps) => {
    ...
    return (
        <main className="relative lg:min-h-full">
            <div className="hidden lg:block h-80 overlow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
                <Image
                    fill
                    ...
                    <div className="lg:col-start-2">
                        ...
                        {order._isPaid ? (
                            <p className="mt-2 text-base text-muted-foreground">
                                Your order was processed. We&apos;ve sent your

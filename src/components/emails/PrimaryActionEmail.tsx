...
export const EmailTemplate = ({
    ...
    return (
        <Html>
            <Head />
            <Preview>The best place to find the best TikTok gadgets.</Preview>
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Text style={paragraph}>
                        Welcome to TikGadets, the world of TikTok&apos;s hidden
                        gems, where you&apos;ll discover must-have products and
                        gadgets that bring joy to your life. Use the button
